...
<div class="wrapper">
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    <section class="content-header">
      <h1>
      <p class="glyphicon glyphicon-dashboard" style="font-size:20px;"><b><i> Dashboard </i></b></p>
...
<!--  end of breadcrumbs-->
 <hr class="main-footer bg-aqua" style="border-radius:4px 4px 4px 4px;margin-top:1%;margin-left:1%;margin-right:1%;">
      <div class="row" >
        <section class="col-lg-10" style="margin-left:8%;margin-top:-1.5%;">

          <div class="box box-info bg-gray">
            <div class="box-header">
              <i class="fa fa-graduation-cap"></i>

                <h3 class="box-title glyphicon glyphicon-info-sign"></h3><b>COUNTY Information</b>

            </div>
            <div class="box-body"style="background-color:#d24dff;">
            ...
            <div class="box-footer clearfix">
              <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="addcounty" id="sendEmail"> Add County
