...
<head>
  ...
  <title>AMVS | ConstituencyRet Dashboard</title>
      ...
      <div class="navbar-custom-menu">
        ...
        ?>
              ...
              <li class="user-footer" style="background-color: gray;">
                <div class="pull-left">
                  <a id="returnings_profile" class="btn btn-primary btn-flat bg">Profile</a>
                </div>
        ...
        $sql = "SELECT * FROM returnings where  email='$myusername'";
         ...
         if ($avatar == null) {
           if ($gender == "Male") {
            ...
            echo '<img style="height:40px;" src="../uploads/'.$row['photo'].'" class="img-circle" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'"/>';
         }
                     }
                   } else {
...
<button class="sidebar-menu btn btn-block btn active header glyphicon glyphicon-inbox" style="color: black;padding: 7px;background-color:#1f3f24;"><b style="color: white;"> Election Results <span class="caret"></span></b></button>
</a>
</h4>
...
<div class="">
     ...
     <!--  <li class="treeview alert alert" style="margin-left:1%;margin-right:1%;">
        <a id="loadpollingresults" style="text-decoration:none;">
          <i class="fa fa-user glyphicon glyphicon-play" style="text-decoration:none; color:#e68a00;font-size:10px;"></i>
         <button type="button" class="btn btn-default" style="font-size:12px;"><b>Polling Results</b></button>
        </a>
      </li> -->
        <li class="treeview alert alert" style="margin-left:1%;margin-right:1%;">
          <a  style="text-decoration:none;" id="loadwardresults">
          <!-- <a href="add_president.php"style="text-decoration:none;"> -->
            <i class="fa fa-user glyphicon glyphicon-play" style="text-decoration:none; color:#e68a00;font-size:10px;"></i>
            <button type="button" class="btn btn-default" style="font-size:12px;"><b> Ward Results</b></button>
          </a>
        </li>
        <li class="treeview alert alert" style="margin-left:1%;margin-right:1%;">
...
<div id="loadchairsessionvoting" class="well pull-left" style="width: 27%;min-width: 230px;margin-top: -6%;"> 
  ...
  <div class="content-wrapper well" style="background-color:white;">
    <section class="content-header well" style="padding: 1px;margin-top: -1.7%;">
      <h1>
        <p class="glyphicon glyphicon-dashboard " style="font-size:20px;"></p><b style="font-size:18px;"><i> Constituency-Ret Dashboard</b></i>

      </h1>
      <ol class="breadcrumb" style="margin-top: -2.4%;">
        <li><a href=""><i class="fa fa-dashboard btn btn glyphicon glyphicon-th-large"> <?php echo 'Constituency: '.$constituency_name; ?></i> </a></li>
...
<script type="text/javascript">
  var currentTime = new Date();
    ...
    //load polling results
     $('#loadpollingresults').click(function(){
       $.ajax({
      url:"load_polling_results.php",
      method:"POST",
     ...
     //load ward results
       $('#loadwardresults').click(function(){
       $.ajax({
      url:"load_ward_results.php",
      method:"POST",
      success:function(data){
        $('#loadpresidingres').html(data);
      }
      ...
      success:function(data){
       ...
       $('#returnings_profile').click(function(){
    updatereturningprofile();
     $('#myModal').modal({"backdrop":"static"});
         $("#myModalLabel").html("Update Returning Profile Details");  
          $("#myModal").modal('show');
           $('#okay').click(function(){
          updatereturningprofile();
         });
   ...
   function updatereturningprofile(){
       $.ajax({
