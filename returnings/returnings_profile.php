...
<head>
  ...
  <title>AMVS | ConstituencyRet User Profile</title>
...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
			  ...
			  $sql = "SELECT * FROM returnings where  email='$myusername'";
               $result = $conn->query($sql);
                ...
                while($row = $result->fetch_assoc()) {
				 ...
				 if ($avatar == null) {
					 if ($gender == "Male") {
						 print '<img src="../dist/img/avatar.png" class="user-image" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'">';
					 }else {
						 print '<img src="../dist/img/avatar3.png" class="user-image" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'">';
					 }

				 }else{
					   echo '<img src="../uploads/'.$row['photo'].'" class="user-image" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'"/>';
				 }
                     }
                   } else {
              ...
              <span class="hidden-xs"><?php echo"$current_constituencyret"; ?></span>
            </a>
            <ul class="dropdown-menu">
			  ...
			  $sql = "SELECT * FROM returnings where email='$myusername'";
               $result = $conn->query($sql);
                ...
                while($row = $result->fetch_assoc()) {
				 ...
				 if ($avatar == null) {
					 if ($gender == "Male") {
						 print '<img src="../dist/img/avatar.png" class="img-circle" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'">';
					 }else {
						 print '<img src="../dist/img/avatar3.png" class="img-circle" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'">';
					 }

				 }else{
					  echo '<img src="../uploads/'.$row['photo'].'" class="img-circle" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'"/>';
				 }
                     }
                   } else {
			  ...
			  ?>
                ...
                <p>
                  <?php echo"$current_constituencyret"; ?>
    ...
    <section class="sidebar">
      <div class="user-panel">
        ...
        $sql = "SELECT * FROM returnings where  email='$myusername'";
         ...
         if ($avatar == null) {
           if ($gender == "Male") {
            ...
            echo '<img style="height:70px;" src="../uploads/'.$row['photo'].'" class="img-circle" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'"/>';
         }
                     }
                   } else {
        ...
        <div class="pull-left info">
          <p><?php echo"$current_constituencyret"; ?></p>
          <a href="#"><i class="fa fa-circle text-success"></i><h style="color:cyan;"> Logged In (CountyRet)</h></a>
        </div>
      </div>
        ...
        <li class="treeview alert alert-info" style="margin-left:4%;margin-right:4%;font-size:15px;">
          <a href="" style="text-decoration:none;">
            <i class="fa fa-database"></i>
              <span class="glyphicon glyphicon-refresh" style="color:yellow;"></span><strong style="color:black;"> CountyRet Page Refresh</strong>
          </a>
        </li>
  ...
  echo '<img style="height:150px;width:90%;margin-left:4%;"src="../uploads/'.$row['photo'].'" class="user-image" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'"/>';
  }
   }
  } else {
  ...
  <div class="content-wrapper" style="background-color:#ffff99;">
    <section class="content-header">
      ...
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        <li><a href="returnings.php"><i class="fa fa-dashboard btn btn-primary disabled glyphicon glyphicon-home"> Home</i> </a></li>
        <li><a href=""><i class=" btn btn-primary active" >CountyRet User Profile</i> </a></li>
      </ol>
    </section>
  ...
  <div class="box box-primary">
      ...
      <?php
        ...
        $sql = "SELECT * FROM returnings where email='$myusername'";
         ...
         if ($avatar == null) {
           if ($gender == "Male") {
             print '<img src="../dist/img/avatar.png" class="profile-user-img img-responsive img-circle" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'">';
           }else {
             print '<img src="../dist/img/avatar3.png" class="profile-user-img img-responsive img-circle" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'">';
           }

         }else {
            echo '<img style="height:100px;" src="../uploads/'.$row['photo'].'" class="profile-user-img img-responsive img-circle" alt="'.$current_constituencyret.'" title="'.$current_constituencyret.'"/>';
         }
                     }
                   } else {
        ...
        ?>
              ...
              <h3 class="profile-username text-center"><?php echo"$current_constituencyret"; ?></h3>
             ...
             <form action="update_profile_returnings.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="box box-info">
        <div class="box-header bg-blue">
          <i class="fa fa-user"></i>
              ...
              <h3 class="box-title glyphicon glyphicon-user"></h3>CountyRet Information</h3>
            ...
            <div class="box-body ">
              ...
              <form action="update_user.php" method="post">
                <div class="form-group has-feedback">
                  ...
                  <input type="text" class="form-control" name="name" value="<?php echo"$current_constituencyret"; ?>" placeholder="Enter your fullname" required>
                </div>
