             ...
             if ($result1->num_rows > 0) {
              while($row1 = $result1->fetch_assoc()) {
                ...
                // $wardcode=$row1['wardcode'];
                          ...
                          ?>
                            <div class="well btn pull-left" style="width: 80%;margin-left: 5px;color: black;min-width: 250px;background-color: #cfd2d6;">
                ...
                <thead>
                      <tr >
                       <th style="font-size: 15px;text-align: center;">Name</th>
                         <th style="font-size: 15px;text-align: center;">Photo</th>
                           <th style="font-size: 15px;text-align: center;">Votes </th>
                    </thead>
                    <tbody >
                <?php
