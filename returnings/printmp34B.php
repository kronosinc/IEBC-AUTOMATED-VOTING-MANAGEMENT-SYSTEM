 ...
 $this->SetDrawColor(0,80,180);
   ...
   // $this->Cell(2);
    ...
    $this->SetFont('Times','',20);
     ...
     $this->Cell(0,20,'MP Results ',0,1,'C');
...
$counts=1;
                        $sql2 = "SELECT * FROM `constituency_results` where constituency='$current_constituency' && type='MP'";
                         ...
                         if ($result2->num_rows > 0) {
                          while($row2 = $result2->fetch_assoc()) {
                           ...
                           $counts++;
                                         ...
                                         $pdf->Cell(100,10,'No Vote For Any MP '.mysqli_error($connection),1,1,'C');
                                     }
  

                         $sql21 = "SELECT mp.Sno,mp.uname,mp.partycode,party.partycode,party.partyname,constituency_results.type,max(constituency_results.votes) as winner,constituency_results.contestant FROM `mp`,party,constituency_results WHERE  mp.partycode=party.partycode && constituency='$current_constituency' && type='MP' order by mp.Sno  ";
