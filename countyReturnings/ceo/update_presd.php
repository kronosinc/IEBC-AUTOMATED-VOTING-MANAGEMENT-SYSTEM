...
if(isset($_POST['ref'])) {
	...
	$sql = "SELECT * FROM presiding where id = '$presdid'";
...
<head>
  ...
  <title>AMVS | Update Presiding<?php echo"$fullname"; ?></title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    <section class="content-header">
        ...
        <h style="font-size:25px;"><b><i>Update Presiding</i></b> <b style="color:blue;">(<?php echo"$presdid"; ?>)</b></h>
      <ol class="breadcrumb">
         <li><a href="view_presd.php"><i class="fa fa-dashboard btn btn-primary disabled glyphicon glyphicon-circle-arrow-left"> Back</i> </a></li>
				  <li><i class=" btn btn-primary active">Update Presiding <?php echo"$presdid"; ?> </i></li>
      </ol>
    </section>
...
?>
              <form action="save_update_presd.php?ref=<?php echo"$presdid"; ?>" method="post">
                <div class="form-group has-feedback">
									<span class="glyphicon glyphicon-phone form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" name="phone"  value="<?php echo"$phone"; ?>" placeholder="Presiding Phone Number" required>

                </div>
                <div class="form-group has-feedback">
									<span class="glyphicon glyphicon-envelope form-control-feedback" style="color:gray;"></span>
                  <input type="email" class="form-control" name="email"  value="<?php echo"$email"; ?>" placeholder="Presiding Email" required>
                </div>
