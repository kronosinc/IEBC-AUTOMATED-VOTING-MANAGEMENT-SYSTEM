      <div class="col-lg-3 col-xs-6" style="color:white;">
          <div class="small-box" style="background-color:#669999;">
            <div class="inner">
              <span  style="font-size:100%;"> County Returnings    </span> <span class="badge" style="padding: 10px;font-size:80%;width: 70px;" ><?php
        ...
        <div class="col-lg-3 col-xs-6" style="color:white;">
          <div class="small-box"style=" background-color:#40bf40;">
            <div class="inner">
            <span  style="font-size:100%;"> Presidings</span>  <span class="badge" style="padding: 10px;font-size:80%;width: 70px;" ><?php include '../db_config/connection.php';
        ...
        <div class="col-lg-3 col-xs-6" style="color:white;">
          <div class="small-box " style="background-color:#3366cc;">
            <div class="inner">
                <span  style="font-size:100%;"> Returnings</span> <span class="badge" style="padding: 10px;font-size:80%;width: 70px;" ><?php include '../db_config/connection.php';
        ...
        <div class="col-lg-3 col-xs-6" style="color:white">
          <div class="small-box " style="background-color:#bf8040;">
            <div class="inner">
              <span  style="font-size:100%;"> Clerks</span> <span class="badge" style="padding: 10px;font-size:80%;width: 70px;" ><?php include '../db_config/connection.php';
