              ...
              while($row1 = $result1->fetch_assoc()) {
                ...
                // $wardcode=$row1['wardcode'];
                          ...
                          ?>
                            ...
                            <h4 class="badge" style="margin-top: -1.8%;"><?php echo $row1['countyname'];?></h4>
                            <div class="panel">
                ...
                <?php
                          ...
                          //select all governor from that ward

                        $sql2 = "SELECT * FROM `county_results` where county='$current_county' && type='Governor'";
                         $result2 = $conn->query($sql2);
                         if ($result2->num_rows > 0) {
                          while($row2 = $result2->fetch_assoc()) {
                            $pres=$row2['contestant'];

                               $sql21 = "SELECT * FROM governor where Sno='$pres' and countycode='$current_county' ORDER BY Sno ";
