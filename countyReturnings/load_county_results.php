<div class="box-header" style="background-image: url('../dist/img/boxed-bg.jpg');background-repeat: no-repeat;  background-size: cover;background-position: center;opacity:0.9;">
              ...
              <h3 class="box-title glyphicon glyphicon-info-sign" style="color:green;"></h3><b>County Results Information</b>
   ...
   <!-- lkkjuu -->
            ...
            <div id="myTabContent" class="tab-content" style="margin-top: 1%;">
                ...
                <!-- presidential results panel -->
                 <div class="btn btn- well pull-left"  style="color:black;width: 100%;min-width:240px;margin-left: 2px;padding: 1px;">
                  <div class="panel" >
                 <div class="pull-left" >
                        <button class="badge bg-green" style="margin-top:12%;"><h style="color: yellow;margin-top:12%;"><b> County </b></h></button>
                     
                    </div>
                   <h5 style="text-align: center;font-size: 20px;" >Presidential Results  <h class="pull-right" style="margin-top: -0.5%;padding-right: 2px;"> 
                   <div class="pull-right" >
                        <a href="printpresident34B.php" target="_blank" class="" style="font-size: 10px;margin: 0px;" ><button class="btn btn-large btn-info printpresident box-title glyphicon glyphicon-print " style="margin: 0px;margin-top:-49%;background-color: #4bed66;"><h style="color: white;"><b> Print </b></h></button> </a>
                ...
                <div class="btn btn- well pull-left"  style="color:black;width: 100%;min-width:240px;margin-left: 10px;padding: 3px;">
                       ...
                       <h5 style="text-align: center;font-size: 20px;" >Gubernatorial Results  <h class="pull-right" style="margin-top: -0.5%;padding-right: 2px;"> <div class="pull-right" >
                        <a href="printpresident34B.php" target="_blank" class="" style="font-size: 10px;margin: 0px;" ><button class="btn btn-large btn-info printpresident box-title glyphicon glyphicon-print " style="margin: 0px;margin-top:-49%;background-color: #4bed66;"><h style="color: white;"><b> Print </b></h></button> </a>
     ...
     $.ajax({
        url:"load_countygovernor_votes.php",
        method:"POST",
        success:function(data){
