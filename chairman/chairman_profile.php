...
<head>
  ...
  <title>AMVS | Chairman User Profile</title>
    ...
    <section class="sidebar">
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success"></i style="color:blue;"><h style="color:cyan;"> Logged In (Chairman)</h></a>
        </div>
      </div>
...
echo '<img style="height:150px;width:90%;margin-left:4%;"src="data:image;base64,'.$row["photo"].'" class="user-image image-cropper" alt="'.$current_user.'" title="'.$current_user.'"/>';
}
   }
 } else {
...
?>
  ...
  <div class="content-wrapper" style="background-color:#ffff99;">
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-cog" style="font-size:20px;"></p><b style="font-size:18px;"><i> Chairman Profile</b></i>

      </h1>
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        <li><a href="chairman.php"><i class="fa fa-dashboard btn btn-primary disabled glyphicon glyphicon-home"><b> Home</b></i> </a></li>
        <li><a href=""><i class=" btn btn-primary active" >Chairman User Profile</i> </a></li>
      </ol>
    </section>
...
<div class="box box-primary">
			...
			<?php
             ...
             <form action="update_profile_chairman.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="box box-info">
        <div class="box-header bg-blue">
          <i class="fa fa-user"></i>
              ...
              <h3 class="box-title glyphicon glyphicon-user"></h3>Chairman Information</h3>
