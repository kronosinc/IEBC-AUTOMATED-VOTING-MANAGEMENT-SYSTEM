...
$photo='';
  ...
  if($nid > 8 || $phone > 13)
  {
$result = mysqli_query($conn, "INSERT INTO mp( uname, nid, countycode, constituencycode, partycode, gender, photo ) VALUES ('$uname','$nid','$countycode','$constituencycode','$partycode','$gender','$photo' )" ) or die(mysqli_error($conn));
    if($result>0)
    {
      echo "MP details uploaded successfully!!";
