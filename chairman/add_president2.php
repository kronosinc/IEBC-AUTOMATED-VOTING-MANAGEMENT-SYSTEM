...
$photo='';
  ...
  if($nid > 8 || $phone > 13)
  {
$result = mysqli_query($conn, "INSERT INTO president( uname, nid, partycode, gender, photo ) VALUES ('$uname','$nid','$partycode','$gender','$photo' )" ) or die(mysqli_error($conn));
    if($result>0)
    {
      echo "PRESIDENT details uploaded successfully!!";
