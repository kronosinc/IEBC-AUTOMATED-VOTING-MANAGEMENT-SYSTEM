...
$photo='';
  ...
  if($nid > 8 || $phone > 13)
  {
$result = mysqli_query($conn, "INSERT INTO governor( uname, nid, countycode, partycode, gender, photo ) VALUES ('$uname','$nid','$countycode','$partycode','$gender','$photo' )" ) or die(mysqli_error($conn));
    if($result>0)
    {
     echo "GOVERNOR details uploaded successfully!!";
    }
    else {
