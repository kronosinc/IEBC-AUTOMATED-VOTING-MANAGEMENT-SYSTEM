 ...
 $this->SetDrawColor(0,80,180);
   ...
   // $this->Cell(2);
    ...
    $this->SetFont('Times','',20);
     ...
     $this->Cell(0,20,'FORM 34A: Gubernatorial Results ',0,1,'C');
 ...
 $myusername = $_SESSION['presiding_username'];
  ...
  header("Location:../index.php?login_err=Login First");
    ...
    //select applicant info
      $counts=1;
          $sql1 = "SELECT * FROM `presiding_results` where polling='$currentpolling' && type='Governor'";
                      ...
                      if(mysqli_num_rows($resultvote)>0){
                        while($row21 =mysqli_fetch_array($resultvote)) {
                           ...
                           $counts++;
                              ...
                              $pdf->Cell(100,10,'Governor not Found ',1,0,'C');
                       ...
                       $pdf->Cell(100,10,'No Vote For Any Governor '.mysqli_error($conn),1,0,'C');
