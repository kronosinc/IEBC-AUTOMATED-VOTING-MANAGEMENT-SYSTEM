 ...
 $this->SetDrawColor(0,80,180);
   ...
   // $this->Cell(2);
    ...
    $this->SetFont('Times','',20);
     ...
     $this->Cell(0,20,'FORM 34A: Women Rep Results ',0,1,'C');
                      ...
                      if(mysqli_num_rows($resultvote)>0){
                        while($row21 =mysqli_fetch_array($resultvote)) {
                           ...
                           $counts++;
                              ...
                              $pdf->Cell(100,10,'WomenRep not Found ',1,0,'C');
                       ...
                       $pdf->Cell(100,10,'No Vote For Any WomenRep '.mysqli_error($conn),1,0,'C');
