...
<div class="table-responsive">
                            ...
                            <thead>
                                  <tr ><th>Sno</th>
                                   <th style="font-size: 15px;">Women Representative Name</th>
...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
 $myusername = $_SESSION['presiding_username'];
  ...
  header("Location:../index.php?login_err=Login First");
         ...
         $counts=1;
          $sql1 = "SELECT * FROM `presiding_results` where polling='$currentpolling' && type='WomenRep'";
                      ...
                      if(mysqli_num_rows($resultvote)>0){
                        while($row21 =mysqli_fetch_array($resultvote)) {
                           ...
                           $counts++;
                               ...
                               echo '<tr><td colspan="3">Women Representative not Found</td></tr>';
                               
                            }
                      }
                    }
                    else{
                              echo '<tr><td colspan="3">No Vote For Any Women Representative</td></tr>';
                         }
           ?>
            </tbody>
         </table> 