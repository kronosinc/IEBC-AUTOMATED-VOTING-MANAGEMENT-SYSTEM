...
<head>
  ...
  <title>AMVS | Registrar Rules</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
     ...
     <ul class="treeview-menu">
           ...
           <li><a href="reg_voter.php"><i class="fa fa-circle-o"></i> Add Voter</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        AMVS Electoral Guidelines

      </h1>
      <ol class="breadcrumb">
        <li><a href="./"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Electoral Regulations</li>
      </ol>
    </section>

    <section class="content">
<div class="callout callout-info">
        <h4>Electoral Regulations!</h4>
    <ul>
	<li>The cmmision allows you to register legible voters</li>
	<li>Each voter to be registered MUST have an ID</li>
	<li>You are required to adhere to all the rules here</li>
	<li>Make sure you capture valid details to the databases</li>
	<li>DO NOT refresh the page during registration</li>
	</ul>
	...
	<li>Several Umbiguity</li>
	<li>Cumbersome Workloads</li>
	</ul>
