...
<div class="wrapper">
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    ...
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-pencil" style="font-size:20px;"></p><b style="font-size:18px;"><i> Ward Registration Section</b></i>
      ...
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        ...
        <li><a href=""><i class=" btn btn-primary active glyphicon glyphicon-random"> Ward Registration</i> </a></li>
      </ol>
    </section>
        ...
        <div class="row">
          <section class="col-lg-12">
            ...
            <div class="box box-info"style="margin-top:-0.3%;">
              <div class="box-header"<div class="box-header"style="background-image: url('../dist/img/boxed-bg.jpg');background-repeat: no-repeat;  background-size: cover;background-position: center;opacity:1.0;">
                <i class="fa fa-graduation-cap"></i>
                   ...
                   <h3 class="box-title glyphicon glyphicon-info-sign"style="color:green;"></h3><b> Ward Information</b>
            ...
            <div class="box-body col-lg-11"style="background-color:#d24dff;margin-left:4%;margin-top:0.5%;margin-bottom:1%;">
              <!-- <form action="add_ward2.php" method="post"> -->
                <div class="form-group has-feedback">
                  <span class="glyphicon glyphicon-certificate form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" name="wardcode" id="wardcode"  placeholder="Ward Code" maxlength="5" minlength="5" required>
                </div>
                <div class="form-group has-feedback">
                  <span class="glyphicon glyphicon-pencil form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" name="wardname" id="wardname" placeholder="Ward Name" required>
                </div>
              ...
              <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="addward" id="saveward"> Add Ward
...
//display on loading the add ward page
      ...
      $.ajax({
       ...
       $('#saveward').click(function(){
              ...
              if(wardcode==""){
                  ...
                  $('#msg').html("Please enter Valid Ward Name");
                  $("#myModalLabel").html("Ward Name Error");
                  $("#myModal").modal('show');
              }
        ...
        url:"add_ward2.php",
        method:"POST",
        data:{addward:addward,countycode:countycode,wardname:wardname,constituencycode:constituencycode,wardcode:wardcode},
        dataType:"text",
        success:function(data){
          $('#msg').html(data);
