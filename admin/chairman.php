    ...
    <section class="sidebar">
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success"></i><h style="color:cyan;"> Logged In (Chairman)</h></a>
        </div>
      </div>
        ...
        <li class="treeview alert alert-info" style="margin-left:4%;margin-right:4%;font-size:15px;">
          <a href="" style="text-decoration:none;">
            <i class="fa fa-database"></i>
              <span class="glyphicon glyphicon-refresh" style="color:yellow;"></span><b style="color:black;"> Page Refresh</b>
          </a>
        </li>
...
<button class="sidebar-menu btn btn-block btn-default active header glyphicon glyphicon-user" style="color: black;padding: 7px;"><b> Manage Candidates <span class="caret"></span></b></button>
</a>
...
<button class="sidebar-menu btn btn-block btn-default active header glyphicon glyphicon-user" style="color: black;padding: 7px;"><b>Voters and Voting <span class="caret"></span></b></button>
</a>
</h4>
...
<div class="">
      ...
      <li class="treeview alert alert" style="margin-left:1%;margin-right:1%;">
        ...
        <li class="treeview alert alert" style="margin-left:1%;margin-right:1%;">
         ...
         <li class="treeview alert alert" style="margin-left:1%;margin-right:1%;">
          <!-- <a href="add_party.php" style="text-decoration:none;"> -->
           <a href="load_presidential_chair.php"   style="text-decoration:none;">
            <i class="fa fa-user glyphicon glyphicon-play" style="text-decoration:none; color:#e68a00;font-size:10px;"></i>
            <button type="button" class="btn btn-default" style="font-size:12px;"><b>Other Contestants</b></button>
          </a>
        </li>
      </ul>
</div>
...
<button class="sidebar-menu btn btn-block btn-default active header glyphicon glyphicon-user" style="color: black;padding: 7px;"><b>Voting and Registration <span class="caret"></span></b></button>
</a>
</h4>
      <div id="collapsvotingregistration" class=" collapse ">
<div class="">
      <ul class="sidebar-menu" style="background-color:;">
...
<hr style="border: 1px solid darkslategray;border-radius: 4px 4px 4px 4px;">
 ...
 <table id="bod" class="countdownContainer" style="margin-top:1.5px;">
          <tr class="info">
            <td colspan="4" class="info" style="background-color:black;color:green;"><b>End-Election Countdown</b></td>
          </tr>
  ...
  <div class="content-wrapper" style="background-color:#ffff99;">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb pull-right bg-green" style="margin-top:-0.8%;">
        ...
        <li><a href=""><i class=" btn btn-primary active"> Chairman Dashboard</i> </a></li>
      </ol>
    </section>
  ...
  <section class="content" style="margin-top:-2.5%;">
   <div id="loadchairsessionvoting" class="well pull-left" style="width: 40%;min-width: 250px;"> 
  
   </div>
   
   <div id="loadpresidentialres" class="well pull-right" style="width: 55%;min-width: 250px;"> 
...
<script type="text/javascript">
  ...
  //view all county votes for president
  ...
  $('#votingdate').click(function(){
        ...
        $('#loadpresidentialres').html('<h2>Setting General Election Voting Time and Date</h2><div class="panel"><form role="form" class="form-horizontal"><div class="form-group has-feedback"> <label class="col-sm-2 control-label">Start Date Election:</label><div class="col-sm-10"> <span class="glyphicon glyphicon-certificate form-control-feedback" style="color:gray;"></span> <input type="date" class="form-control" name="startdatevoting"  placeholder="dd/mm/yy" id="startdatevoting"  required></div> </div><div class="form-group has-feedback"><label class="col-sm-2 control-label">End Date Election:</label> <div class="col-sm-10"> <span class="glyphicon glyphicon-certificate form-control-feedback" style="color:gray;"></span> <input type="date" class="form-control" name="enddatevoting"  placeholder="dd/mm/yy" id="enddatevoting"  required> </div></div> <div class="form-group has-feedback"><label class="col-sm-2 control-label">Start Time Election:</label> <div class="col-sm-10"> <span class="glyphicon glyphicon-pencil form-control-feedback" style="color:gray;"></span><input type="time" class="form-control" name="starttimevoting" placeholder="county Name" id="starttimevoting" required></div> </div><div class="form-group has-feedback"><label class="col-sm-2 control-label">End Time Election:</label><div class="col-sm-10"> <span class="glyphicon glyphicon-pencil form-control-feedback" style="color:gray;"></span><input type="time" class="form-control" name="endtimevoting" placeholder="county Name" id="endtimevoting" required></div></div> <div class="form-group has-feedback"><label class="col-sm-3 control-label">Duration:</label> <div class="col-sm-9"> <span class="glyphicon glyphicon-certificate form-control-feedback" style="color:gray;"></span> <input type="number" class="form-control" name="durationvoting"  placeholder="Enter Duration In minutes" id="durationvoting"  required> </div></div>  <button type="button" class="pull-right btn btn-success glyphicon glyphicon-send" name="addvotingdate" id="addvotingdate"> Set Election Date and Time  <i class="fa fa-arrow-circle-up"></i></button>  </form></div><br>');
      ...
      type:"POST",
      data:{startdatevoting:startdatevoting,enddatevoting:enddatevoting,starttimevoting:starttimevoting,endtimevoting:endtimevoting,addvotingdate:addvotingdate},
      dataType:"text",
      success:function(data){
        $('#replaymsg').html(data);
  ...
  $('#registrationdate').click(function(){
        ...
        $('#loadpresidentialres').html('<h2>Setting Registration Of New Voters Time and Date</h2><div class="panel"><form role="form" class="form-horizontal"><div class="form-group has-feedback"> <label class="col-sm-3 control-label">Start Date Registration:</label><div class="col-sm-9"> <span class="glyphicon glyphicon-certificate form-control-feedback" style="color:gray;"></span> <input type="date" class="form-control" name="startdatereg"  placeholder="dd/mm/yy" id="startdatereg" maxlength="4" minlength="4" required></div> </div><div class="form-group has-feedback"><label class="col-sm-3 control-label">End Date Registration:</label> <div class="col-sm-9"> <span class="glyphicon glyphicon-certificate form-control-feedback" style="color:gray;"></span> <input type="date" class="form-control" name="enddatereg"  placeholder="dd/mm/yy" id="enddatereg" maxlength="4" minlength="4" required> </div></div> <div class="form-group has-feedback"><label class="col-sm-3 control-label">Start Time Registration:</label> <div class="col-sm-9"> <span class="glyphicon glyphicon-pencil form-control-feedback" style="color:gray;"></span><input type="time" class="form-control" name="starttimereg" placeholder="county Name" id="starttimereg" required></div> </div><div class="form-group has-feedback"><label class="col-sm-3 control-label">End Time Registration:</label><div class="col-sm-9"> <span class="glyphicon glyphicon-pencil form-control-feedback" style="color:gray;"></span><input type="time" class="form-control" name="endtimereg" placeholder="county Name" id="endtimereg" required></div></div><div class="form-group has-feedback"><label class="col-sm-3 control-label">Duration:</label> <div class="col-sm-9"> <span class="glyphicon glyphicon-certificate form-control-feedback" style="color:gray;"></span> <input type="number" class="form-control" name="durationregistration"  placeholder="Enter Duration In minutes" id="durationregistration"  required> </div></div>  <button type="button" class="pull-right btn btn-success glyphicon glyphicon-send" name="addregdate" id="addregdate"> Set Registration Date and Time  <i class="fa fa-arrow-circle-up"></i></button>  </form></div><br>');
      ...
      type:"POST",
      data:{startdatereg:startdatereg,enddatereg:enddatereg,starttimereg:starttimereg,endtimereg:endtimereg,addregdate:addregdate},
      dataType:"text",
      success:function(data){
        $('#replaymsg').html(data);
