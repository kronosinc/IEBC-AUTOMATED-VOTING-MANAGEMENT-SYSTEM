...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview alert alert-danger" style="margin-left:4%;margin-right:4%;font-size:15px;">
              ...
              <ul class="treeview-menu" style="background-color:black;">
                <li><a href="new_presd.php"style="text-decoration:none;"><i class="fa fa-circle-o"></i> Register New presiding</a></li>
                <li><a href="view_presd.php"style="text-decoration:none;"><i class="fa fa-circle-o"></i> Customize Presidings</a></li>
              </ul>
            </li><br>
    ...
    <li class="treeview alert alert-success" style="margin-left:4%;margin-right:4%;font-size:15px;">
      ...
      <div class="content-wrapper"style="background-color:#ffff99;">
        ...
        <section class="content-header">
          <h1>
            <p class="glyphicon glyphicon-pencil" style="font-size:20px;"></p><b style="font-size:18px;"><i> Presiding Registration Section</b></i>
          ...
          <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
            ...
            <li><a href=""><i class=" btn btn-primary active glyphicon glyphicon-random"> Presiding Registration</i> </a></li>
          </ol>
        </section>
              ...
              <section class="col-lg-12">
                ...
                <div class="box box-info"style="margin-top:-0.3%;">
                  <div class="box-header"<div class="box-header"style="background-image: url('../dist/img/boxed-bg.jpg');background-repeat: no-repeat;  background-size: cover;background-position: center;opacity:1.0;">
                    ...
                    <h3 class="box-title glyphicon glyphicon-user"style="color:green;"></h3><b>Presiding Information</b>
    ...
    <form action="new_presd2.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" name="phone"  placeholder="254XXX XXX XXX" required minlength="12" maxlength="12">
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        ...
        <input type="password" class="form-control" name="pwd"  placeholder="Password" required>
            ...
            <div class="box-footer clearfix"style="background-image: url('../dist/img/purty_wood.png');background-repeat: no-repeat;  background-size: cover;background-position: center;">
              <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="newpresiding" id="sendEmail"> Register Presiding
