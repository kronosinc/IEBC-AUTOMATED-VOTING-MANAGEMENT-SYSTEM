...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header glyphicon glyphicon-menu-hamburger"style="color:red;margin-left:4%;margin-right:1%;"><b> NAVIGATION PANEL</b></li><hr style="border:1px solid black;">



    <li class="treeview alert alert" style="margin-left:4%;margin-right:4%;font-size:15px;">
          <a href="#"style="text-decoration:none;background-color:red;">
            <i class="fa fa-user"></i>
            <span><b>Chairman Officer</b></span>

          </a>
          <ul class="treeview-menu"style="background-color:black;">
            <li><a href="new_chairman.php"style="text-decoration:none;"><i class="fa fa-circle-o"></i> Register New Chairman</a></li>
            <li><a href="view_chairman.php"style="text-decoration:none;"><i class="fa fa-circle-o"></i> Customize Chairman</a></li>
          </ul>
        </li><br>
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    ...
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-pencil" style="font-size:20px;"></p><b style="font-size:18px;"><i> Chairman Registration Section</b></i>
      ...
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        ...
        <li><a href=""><i class=" btn btn-primary active glyphicon glyphicon-random"> Chairman Registration</i> </a></li>
      </ol>
    </section>
            ...
            <div class="box box-info"style="margin-top:-0.3%;">
              <div class="box-header"<div class="box-header"style="background-image: url('../dist/img/boxed-bg.jpg');background-repeat: no-repeat;  background-size: cover;background-position: center;opacity:1.0;">
                <i class="fa fa-graduation-cap"></i>
                   ...
                   <h3 class="box-title glyphicon glyphicon-user"style="color:green;"></h3><b>Chairman Information</b>
  ...
  <div class="box-body col-lg-6 bg-aqua"style="margin-left:2.5%;margin-top:2%;margin-bottom:1%;">
    <form action="new_chairman2.php"  method="post" enctype="multipart/form-data">
      <div class="form-group has-feedback">
        <span class="glyphicon glyphicon-user form-control-feedback" style="color:gray;"></span>
        <input type="text" class="form-control" name="uname"  placeholder=" Username (FisrtName LastName)" required>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        ...
        <input type="email" class="form-control" name="email"  placeholder="xxx@chairman.org" required>
      </div>
    ...
    <div class="box-body col-lg-5 bg-aqua" style="margin-left:3%;margin-top:2%;margin-bottom:1%;">
      <div class="form-group"name="gender"  >
              ...
              <div class="form-group has-feedback">
                ...
                <input type="file" class="form-control" class="form-control" name="photo" accept="photo/*" onchange="loadFile(event)" required>
              </div>
  ...
  <div class="box-footer clearfix"style="background-image: url('../dist/img/purty_wood.png');background-repeat: no-repeat;  background-size: cover;background-position: center;">
    <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="newchairman" id="sendEmail"> Register Chairman
