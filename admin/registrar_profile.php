...
<head>
  ...
  <title>AMVS | Registrar User Profile</title>
...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="" class="btn btn-default disabled btn-flat bg-green">Profile</a>
                </div>
        ...
        <li class="treeview alert alert-info" style="margin-left:4%;margin-right:4%;font-size:15px;">
          <a href="" style="text-decoration:none;">
            <i class="fa fa-database"></i>
              <span class="glyphicon glyphicon-refresh" style="color:yellow;"></span><strong style="color:black;"> Registrar Page Refresh</strong>
          </a>
        </li>
  ...
  <div class="content-wrapper" style="background-color:#ffff99;">
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-cog" style="font-size:20px;"></p><b style="font-size:18px;"><i> Registrar Profile</b></i>
      ...
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        ...
        <li><a href=""><i class=" btn btn-primary active glyphicon glyphicon-random" > Registrar User Profile</i> </a></li>
      </ol>
    </section>
  ...
  <div class="box box-primary">
      ...
      <?php
        ...
        ?>
             ...
             <form action="update_profile_registrar.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="box box-info">
        <div class="box-header bg-blue">
          <i class="fa fa-user"></i>
              ...
              <h3 class="box-title glyphicon glyphicon-user"></h3>Registrar Information</h3>
