...
<head>
  ...
  <link rel="stylesheet" href="../plugins/bootstrap-wysihtml5/
...
<div class="wrapper">
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    ...
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-pencil" style="font-size:20px;"></p><b style="font-size:18px;"><i> Party Registration Section</b></i>
      ...
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        ...
        <li><a href=""><i class=" btn btn-primary active glyphicon glyphicon-random"> Party Registration</i> </a></li>
      </ol>
    </section>
        ...
        <div class="row">
          <section class="col-lg-12">
            ...
            <div class="box box-info"style="margin-top:-0.3%;">
              <div class="box-header"<div class="box-header"style="background-image: url('../dist/img/boxed-bg.jpg');background-repeat: no-repeat;  background-size: cover;background-position: center;opacity:1.0;">
                <i class="fa fa-graduation-cap"></i>
                   ...
                   <h3 class="box-title glyphicon glyphicon-info-sign"style="color:green;"></h3><b> Party Information</b>
            ...
            <div class="box-body col-lg-11"style="background-color:#8080ff;margin-left:4%;margin-top:0.5%;margin-bottom:1%;">
              ...
              <!-- <form action="add_party2.php" method="post"> -->
                <div class="form-group has-feedback">
                    <span class="glyphicon glyphicon-certificate form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" name="partycode"  placeholder="Party Code(XXXX)" id="partycode" maxlength="4" minlength="4" required>
                </div>
                <div class="form-group has-feedback">
                    <span class="glyphicon glyphicon-pencil form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" name="partyname" placeholder="Party Name" id="partyname" required>
                </div>
              </div>
              ...
              <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="addparty" id="saveparty"> Add Party
...
<script type="text/javascript">
  $('#saveparty').click(function(){
              ...
              var addparty="addparty";
              if(partycode==""){
                  $('#msg').html("Please enter Valid Party Code");
                  $("#myModalLabel").html("Party Code Error");
                  $("#myModal").modal('show');
              }
              else if(partyname==""){
                  $('#msg').html("Please enter Valid Party Name");
                  $("#myModalLabel").html("Party Name Error");
                  $("#myModal").modal('show');
              }
              else{
          $.ajax({
        url:"add_party2.php",
        method:"POST",
        data:{addparty:addparty,partycode:partycode,partyname:partyname},
        dataType:"text",
