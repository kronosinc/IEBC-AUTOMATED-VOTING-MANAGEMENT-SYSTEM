...
<li class="treeview alert alert-success" style="margin-left:4%;margin-right:4%;font-size:15px;">
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    ...
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-pencil" style="font-size:20px;"></p><b style="font-size:18px;"><i> MCA Registration Section</b></i>
      ...
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        ...
        <li><a href=""><i class=" btn btn-primary active glyphicon glyphicon-random"> MCA Registration</i> </a></li>
      </ol>
    </section>
        ...
        <div class="row">
          <section class="col-lg-12">
            ...
            <div class="box box-info"style="margin-top:-0.3%;">
              <div class="box-header"<div class="box-header"style="background-image: url('../dist/img/boxed-bg.jpg');background-repeat: no-repeat;  background-size: cover;background-position: center;opacity:1.0;">
                <i class="fa fa-graduation-cap"></i>
                   ...
                   <h3 class="box-title glyphicon glyphicon-info-sign"style="color:green;"></h3><b> MCA Information</b>
            ...
            <div class="box-body col-lg-11"style="background-color:#8080ff;margin-left:4%;margin-top:0.5%;margin-bottom:1%;">
              ...
              <form action="add_mca2.php" method="post" enctype="multipart/form-data">
                <div class="form-group has-feedback">
                  <span class="glyphicon glyphicon-user form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" name="uname"  placeholder="Name of Candidate" required>
                </div>
                <div class="form-group has-feedback">
                ...
                <div class="form-group">
                  <select class="form-control" name="wardcode" id="wardcode" >
              ...
              <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="addmca" id="sendEmail"> Add MCA
