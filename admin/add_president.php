...
<li class="treeview alert alert-warning" style="margin-left:4%;margin-right:4%;font-size:15px;text-decoration:none;">
  <a href="management.php" style="text-decoration:none;">
    <i class="fa fa-database"></i>
    <span><strong>Manage Contestants</strong></span>
  </a>
</li>
...
<li class="treeview alert alert-success" style="margin-left:4%;margin-right:4%;font-size:15px;">
  <a href="add_party.php" style="text-decoration:none;">
    <i class="fa fa-database"></i>
    <span><strong>Add Party </strong></span>
  </a>
</li>
      </ul>
    </section>
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    ...
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-pencil" style="font-size:20px;"></p><b style="font-size:18px;"><i> President Registration Section</b></i>
      ...
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        ...
        <li><a href=""><i class=" btn btn-primary active glyphicon glyphicon-random"> President Registration</i> </a></li>
      </ol>
    </section>
            ...
            <div class="box box-info" style="margin-top:-0.3%;">
              <div class="box-header" style="background-image: url('../dist/img/boxed-bg.jpg');background-repeat: no-repeat;  background-size: cover;background-position: center;opacity:1.0;">
                <i class="fa fa-graduation-cap"></i>
                   ...
                   <h3 class="box-title glyphicon glyphicon-info-sign" style="color:green;"></h3><b> President Information</b>
              ...
              <form action="add_president2.php" method="post" enctype="multipart/form-data" id="presidentform" onsubmit="validatepresident()">
                <div class="box-body col-lg-11" style="background-color:#8080ff;margin-left:4%;margin-top:0.5%;margin-bottom:1%;">
                <div class="form-group has-feedback">
                  <span class="glyphicon glyphicon-user form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" name="uname" id="uname"  placeholder="Name of Candidate" required>
                </div>
                <div class="form-group has-feedback">
                  <span class="glyphicon glyphicon-asterisk form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" name="nid" id="nid" placeholder="National ID" maxlength="8" minlength="8" required>
                </div>
                ...
                <div class="form-group has-feedback">
                  ...
                  <input type="file" class="form-control" name="photo" id="photo" accept="photo/*"  onchange="loadFile(event)" required>
                  <img id="output" width="100px" height="50px"/>
                </div>
              ...
              <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="addpresident" id="savepresident"> Add President
...
<script type="text/javascript">
  ...
  function validatepresident(){
      var uname=$('#uname').val();
              ...
              if(uname==""){
                  $('#msg').html("Please enter Valid Full Name");
                  $("#myModalLabel").html("Full Name Error");
                  $("#myModal").modal('show');
              }
              else if(nid==""){
                  $('#msg').html("Please enter Valid National ID Number");
                  $("#myModalLabel").html("National ID Number Error");
                  $("#myModal").modal('show');
              }
          
               else if(partycode==""){
                  $('#msg').html("Please Choose Valid Party Code");
                  $("#myModalLabel").html("Party Code Error");
                  $("#myModal").modal('show');
              }
               else if(gender==""){
                  $('#msg').html("Please Choose Valid Gender");
                  $("#myModalLabel").html("Gender Error");
                  $("#myModal").modal('show');
              }
  }
  // $('#savepresident').click(function(){
  //             var uname=$('#uname').val();
  //             var nid=$('#nid').val();
  //             var partycode=$('#partycode').val();
  //             var addpresident="addpresident";
  ...
  //       method:"POST",
  //       data:{addpresident:addpresident,uname:uname,nid:nid,partycode:partycode,gender:gender},
  //       contentType:false,
  //       processData:false,
  //       success:function(data){
  //         $('#msg').html(data);
  //         $("#myModalLabel").html("President Saving Info");
  //         $("#myModal").modal('show');
  //       }
