...
if(isset($_GET['ref'])) {
	...
	$sql = "SELECT * FROM constituency where id = '$constituencyid'";
...
<head>
  ...
  <title>AMVS | <?php echo"$constituencyname"; ?></title>
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    <section class="content-header">
      <h1 class="glyphicon glyphicon-save"></h1>
        <h style="font-size:25px;"><b><i>Update Constituency</i></b> <b style="color:blue;">(<?php echo"$constituencyid"; ?>)</b></h>


      <ol class="breadcrumb">
				<li><a href="view_constituencies.php"><i class="fa fa-dashboard btn btn-primary disabled glyphicon glyphicon-circle-arrow-left"> Back</i> </a></li>
				 <li><i class=" btn btn-primary active">Update Constituency <?php echo"$constituencyid"; ?> </i></li>
      </ol>
    </section>
        ...
        <section class="col-lg-12">
          ...
          <div class="box box-info bg-gray">
            <div class="box-header">
              ...
              <p class="box-title glyphicon glyphicon-info-sign"></p> <h style="font-size:20px;"><b> <?php echo"$constituencyname"; ?></b> Information</h>
...
?>
              <form action="save_update_reg.php?ref=<?php echo"$constituencyid"; ?>" method="post">
                <div class="form-group has-feedback">
									<span class="glyphicon glyphicon-phone form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" name="constituencyname"  value="<?php echo"$constituencyname"; ?>" placeholder="Constituency Name" required>
                ...
                <div class="form-group has-feedback">
                  ...
                  <input type="email" class="form-control" name="constituencycode"  value="<?php echo"$constituencycode"; ?>" placeholder="Constituency Code" required>
                </div>


            </div>
            <div class="box-footer clearfix bg-green">
              <button onclick="return confirm('Are you sure you want to Update')" type="submit" class="pull-right btn btn-warning glyphicon glyphicon-send" name="newconstituency" id="sendEmail"> Update <?php echo"$constituencyname"; ?>
