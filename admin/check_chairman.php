...
<!-- Modal -->
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false" style="padding:10px;background-color: white;">
...
$result = $conn->query($sql);
 if ($result->num_rows ==1) {
    ...
    ?>
      	 $("#msg").html("Chairman Already in The System. Please Customize.");
         $("#confirmresultstransmission").hide();
           $("#myModal").modal('show');
      //window.alert("hi");
       $('#pressokay').click(function(){
         window.location=('view_chairman.php');
