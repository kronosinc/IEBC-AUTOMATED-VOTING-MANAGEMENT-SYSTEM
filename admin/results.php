...
<head>
  ...
  <title>MUST | Examination Results</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    <a href="#" class="logo">
      <span class="logo-mini"><b>M</B>UST</span>
...
$conn->close();
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> Developed By <a target="_blank" href="http://facebook.com/narbie1995">Meru Examination System</a>.</strong> All rights
    reserved.
  </footer>
