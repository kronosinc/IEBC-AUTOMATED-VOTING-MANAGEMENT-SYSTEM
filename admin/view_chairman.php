...
<head>
  ...
  <title>Chairman | ICT Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-upload" style="font-size:20px;"></p><b><i> AMVS Chairman Credentials</b></i>

      </h1>
      <ol class="breadcrumb">
        <li><a href="./"><i class="fa fa-dashboard btn btn-primary disabled glyphicon glyphicon-home"> Home</i> </a></li>
        <li><a href=""><i class=" btn btn-primary active"> Uploaded Chairman</i> </a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-lg-12 col-xs-6"style="margin-top:-0.3%;">
          <div class="small-box bg-aqua">
            ...
            <div class="icon">
              <i class="fa fa-thumbs-on-down"></i>
            </div>
      ...
      <div class="row">
        <section class="col-lg-7 bg-aqua"style="margin-top:-1.5%;">
          ...
          <div class="box box-info">
            <div class="box-header bg-blue">
              ...
              <h3 class="box-title glyphicon glyphicon-info-sign"></h3><b>CHAIRMAN Information</b>
			  <?php
			  include '../db_config/connection.php';
            ...
            <div class="box-body">
              ...
              <form action="update_chairman.php" method="post">
                ...
                <div class="form-group has-feedback">
                  ...
                  <input type="email" class="form-control" name="email" value="<?php echo"$email"; ?>" placeholder="Chairman Email" required>
                </div>
				        <div class="form-group has-feedback">
                  ...
                  <input type="text" class="form-control" name="phone" value="<?php echo"$phone"; ?>" placeholder="Chairman Telphone" maxlength="13" required>
                </div>

            </div>
            <div class="box-footer clearfix bg-gray">
              <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="upchairman" id="sendEmail"> Update Chairman Credentials
		...
		<div class="box box-info ">
            <div class="box-header bg-blue">
              ...
              <h3 class="box-title">
                  <h3 class="box-title glyphicon glyphicon-picture"></h3><b> CHAIRMAN Photo</b>
              </h3>
...
print '<div class="callout callout-danger">
        <h4>Could not update Chairman photo!</h4>
        '.$error.'
      </div>';
}
?>
            ...
            <form action="update_chairman_photo.php" method="POST" enctype="multipart/form-data">
