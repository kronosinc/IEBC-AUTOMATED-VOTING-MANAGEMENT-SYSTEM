...
if(isset($_GET['ref'])) {
	...
	$sql = "SELECT * FROM returnings where id = '$countyretid'";
...
<head>
  ...
  <title>AMVS | Update County-Ret<?php echo"$fullname"; ?></title>
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    <section class="content-header">
      <h1 class="glyphicon glyphicon-save"></h1>
        <h style="font-size:25px;"><b><i>Update County Returning</i></b> <b style="color:blue;">(<?php echo"$countyretid"; ?>)</b></h>
      <ol class="breadcrumb">
         <li><a href="view_countyret.php"><i class="fa fa-dashboard btn btn-primary disabled glyphicon glyphicon-circle-arrow-left"> Back</i> </a></li>
				  <li><i class=" btn btn-primary active">Update County Retrurning <?php echo"$countyretid"; ?> </i></li>
      </ol>
    </section>
...
?>
              <form action="save_update_countyret.php?ref=<?php echo"$countyretid"; ?>" method="post">
                <div class="form-group has-feedback">
									<span class="glyphicon glyphicon-phone form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" name="phone"  value="<?php echo"$phone"; ?>" placeholder="County_Ret Phone Number" required>

                </div>
                <div class="form-group has-feedback">
									<span class="glyphicon glyphicon-envelope form-control-feedback" style="color:gray;"></span>
                  <input type="email" class="form-control" name="email"  value="<?php echo"$email"; ?>" placeholder="County-Ret Email" required>
                </div>


            </div>
            <div class="box-footer clearfix bg-green">
              <button onclick="return confirm('Are you sure you want to Update')" type="submit" class="pull-right btn btn-warning glyphicon glyphicon-send" name="newstd" id="sendEmail"> Update <?php echo"$fullname"; ?>
