...
<head>
  ...
  <title>AOVS | Register Registrar</title>
  ...
  <aside class="main-sidebar">
    ...
    <li class="treeview">
          <a href="#">
            ...
            <span>Chairman Officer</span>

          </a>
          <ul class="treeview-menu">
            <li><a href="new_voter.php"><i class="fa fa-circle-o"></i> View Chairman</a></li>
          </ul>
        </li>
    ...
    <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="new_voter.php"><i class="fa fa-circle-o"></i> View CEO</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="new_voter.php"><i class="fa fa-circle-o"></i> Register New Registrar</a></li>
            <li><a href="voters.php"><i class="fa fa-circle-o"></i> Customize Registras</a></li>
          </ul>
        </li>
    ...
    <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="new_voter.php"><i class="fa fa-circle-o"></i> Register New presiding</a></li>
            <li><a href="voters.php"><i class="fa fa-circle-o"></i> Customize Presidings</a></li>
          </ul>
        </li>
    ...
    <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="new_voter.php"><i class="fa fa-circle-o"></i> Register New County Reg</a></li>
            <li><a href="voters.php"><i class="fa fa-circle-o"></i> Customize County Reg</a></li>
          </ul>
        </li>
    ...
    <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="new_voter.php"><i class="fa fa-circle-o"></i> Register New Agent</a></li>
            <li><a href="voters.php"><i class="fa fa-circle-o"></i> Customize Agents</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Register Registrar</li>
      </ol>
    </section>
        ...
        <section class="col-lg-12">
          ...
          <div class="box box-info">
            <div class="box-header">
              ...
              <h3 class="box-title">Registrar Credentials</h3>
...
?>
              <form action="new_std.php" method="post">
                ...
                <div class="form-group">
                  <select class="form-control" name="gender" required>
                    ...
                    <option value="Male">Kisii</option>
                    <option value="Female">Meru</option>
                    <option value="Male">Nairobi</option>
                    <option value="Female">Kisumu</option>
                  </select>
                </div>
            ...
            <div class="box-footer clearfix">
              <button type="submit" class="pull-right btn btn-default" name="newstd" id="sendEmail">Register Voter
 ...
 <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> Developed By <a target="_blank" href="http://facebook.com/joshua_ariga">AOVS Election System</a>.</strong> All rights
    reserved.
  </footer>
