...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"style="background-color:#1a000d;">
        ...
        <hr style="border:1px solid darkslategray;margin-bottom:9.5%;">
        <hr style="margin-top:-1%;border:2px solid #1a000d;;">
        <hr style="border:2px solid #e68a00;width:91%;">

        <li class="treeview alert alert" style="margin-left:4%;margin-right:4%;font-size:15px;margin-top:-8.7%;">
          <a href="#"style="text-decoration:none;">
            <i class="fa fa-user glyphicon glyphicon-play" style="text-decoration:none; color:#e68a00;font-size:16px;"></i>
            <span><b style="color:yellow;"> Registrar Officer</b></span>

          </a>
          <ul class="treeview-menu" style="background-color:black;">

            <li><a href="new_reg.php"style="text-decoration:none;"><i class="fa fa-circle-o"></i> Register New Registrar</a></li>
            <li><a href="view_reg.php"style="text-decoration:none;"><i class="fa fa-circle-o"></i> Customize Registrars</a></li>
          </ul>
        </li><hr style="border:2px solid #e68a00;width:91%;margin-top:-0.01%;">
        ...
        <hr style="border:2px solid #e68a00;width:91%;margin-top:-0.01%;">
    ...
    <div class="content-wrapper"style="background-color:#ffff99;">
      ...
      <section class="content-header">
        <h1>
          <p class="glyphicon glyphicon-pencil" style="font-size:20px;"></p><b style="font-size:18px;"><i> Registrar Registration Section</b></i>
        ...
        <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
          ...
          <li><a href=""><i class=" btn btn-primary active glyphicon glyphicon-random"> Registrar Registration</i> </a></li>
        </ol>
      </section>
            ...
            <section class="col-lg-12">
              ...
              <div class="box box-info"style="margin-top:-0.3%;">
                <div class="box-header"<div class="box-header"style="background-image: url('../dist/img/boxed-bg.jpg');background-repeat: no-repeat;  background-size: cover;background-position: center;opacity:1.0;">
                  ...
                  <h3 class="box-title glyphicon glyphicon-user"style="color:green;"></h3><b>Registrar Information</b>
  ...
  <div class="box-body col-lg-6 bg-aqua"style="margin-left:2.5%;margin-top:2%;margin-bottom:1%;">
    <form action="new_reg1.php" method="post" enctype="multipart/form-data">
                <div class="form-group has-feedback">
                    <span class="glyphicon glyphicon-user form-control-feedback" style="color:gray;"></span>
                     <input type="text" class="form-control" name="uname"  placeholder=" Username (FirstName Lastname)" required>
                </div>
                <div class="form-group has-feedback">
                    <span class="glyphicon glyphicon-asterisk form-control-feedback" style="color:gray;"></span>
                    <input type="text" class="form-control" name="nid"  placeholder="National ID" required minlength="8"maxlength="8">
                </div>
                <div class="form-group has-feedback">
                    <span class="glyphicon glyphicon-phone form-control-feedback" style="color:gray;"></span>
                   <input type="text" class="form-control" name="phone"  placeholder="254 XXX XXX XXX" required minlength="13"maxlength="13">
                </div>
                <div class="form-group has-feedback">
                ...
                <div class="form-group">
                  <select class="form-control" name="polling" id="pollingcode">
                    <option>Choose Polling Region</option>
            ...
            <div class="box-footer clearfix"style="background-image: url('../dist/img/purty_wood.png');background-repeat: no-repeat;  background-size: cover;background-position: center;">
              <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="newregister" id="sendEmail"> Register Registrar
