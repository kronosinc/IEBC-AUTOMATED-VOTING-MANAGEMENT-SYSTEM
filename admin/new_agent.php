...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="logout.php" class="btn btn-default btn-flat bg-red glyphicon glyphicon-off" style="font-size:15px;"> Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview alert alert-danger" style="margin-left:4%;margin-right:4%;font-size:15px;">
            ...
            <ul class="treeview-menu" style="background-color:black;">
              <li><a href="new_agent.php"style="text-decoration:none;"><i class="fa fa-circle-o"></i> Register New Agent</a></li>
              <li><a href="view_agent.php"style="text-decoration:none;"><i class="fa fa-circle-o"></i> Customize Agents</a></li>
            </ul>
          </li><br>
      ...
      <li class="treeview alert alert-success" style="margin-left:4%;margin-right:4%;font-size:15px;">
          <a href="new_countyret.php"style="text-decoration:none;">
            <i class="fa fa-user"></i>
  ...
  <div class="content-wrapper"style="background-color:#ffff99;">
    ...
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-pencil" style="font-size:20px;"></p><b style="font-size:18px;"><i> Agent Registration Section</b></i>
      ...
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        ...
        <li><a href=""><i class=" btn btn-primary active glyphicon glyphicon-random"> Agent Registration</i> </a></li>
      </ol>
    </section>
          ...
          <section class="col-lg-12">
            ...
            <div class="box box-info"style="margin-top:-0.3%;">
              <div class="box-header"<div class="box-header"style="background-image: url('../dist/img/boxed-bg.jpg');background-repeat: no-repeat;  background-size: cover;background-position: center;opacity:1.0;">
                ...
                <h3 class="box-title glyphicon glyphicon-user"style="color:green;"></h3><b>Agent Information</b>
  ...
  <div class="box-body col-lg-6 bg-aqua"style="margin-left:2.5%;margin-top:2%;margin-bottom:1%;">
    <form action="new_agent2.php" method="post" enctype="multipart/form-data">
                <div class="form-group has-feedback">
                  <span class="glyphicon glyphicon-user form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" style="color:red;" name="uname" placeholder=" Username" required>
                </div>
                <div class="form-group has-feedback">
                  <span class="glyphicon glyphicon-asterisk form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" style="color:red;" name="nid"  placeholder="National ID" maxlength="8" required>
                </div>
                <div class="form-group has-feedback">
                  <span class="glyphicon glyphicon-phone form-control-feedback" style="color:gray;"></span>
                  <input type="text" class="form-control" style="color:red;" name="phone"  placeholder="Phone No" maxlength="12" required>
                </div>
                <div class="form-group has-feedback">
                  <span class="glyphicon glyphicon-envelope form-control-feedback" style="color:gray;"></span>
                  <input type="email" class="form-control" style="color:red;" name="email"  placeholder="Email Address" required>
                </div>
                <div class="form-group" >
                        ...
                        <div class="form-group has-feedback">
                          <select class="form-control" style="color:red;" name="county" id="countycode" required>
                      ...
                      <div class="box-body col-lg-5 bg-aqua" style="margin-left:3%;margin-top:2%;margin-bottom:1%;">
                        <div class="form-group">
                          <select class="form-control" style="color:red;" name="constituency" id="constituencycode" required>
                            <option>Choose County First</option>
                          </select>
                        </div>
                <div class="form-group">
                  <select class="form-control" style="color:red;" name="ward" id="wardcode" required>
                    <option>Choose Constituency First</option>
                  </select>
                </div>
                <div class="form-group">
                  <select class="form-control" style="color:red;" name="polling" id="pollingcode">
                    <option>Choose Ward First</option>
                  </select>
                </div>
                <div class="form-group has-feedback">
                    <span class="glyphicon glyphicon-picture form-control-feedback" style="color:gray;"></span>
                  <input type="file"  class="form-control" name="photo" accept="photo/*" required>
                </div>
           ...
           <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="newagent" id="sendEmail"> Register Agent
