...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
 $myusername = $_SESSION['username'];
  ...
  $current_county=$_SESSION['current_county'] ;
 }
 else{
...
<head>
  ...
  <title>AMVS | CountyRet User Profile</title>
...
<div class="wrapper">
                ...
                while($row = $result->fetch_assoc()) {
				 ...
				 if ($avatar == null) {
					 if ($gender == "Male") {
					   ...
					   echo '<img src="data:image;base64,'.$row["photo"].'" class="user-image" alt="'.$current_countyreturnings.'" title="'.$current_countyreturnings.'"/>';
				 }
                     }
                   } else {
                ...
                while($row = $result->fetch_assoc()) {
				 ...
				 if ($avatar == null) {
					 if ($gender == "Male") {
					  ...
					  echo '<img src="data:image;base64,'.$row["photo"].'" class="img-circle" alt="'.$current_countyreturnings.'" title="'.$current_countyreturnings.'"/>';
				 }
                     }
                   } else {
        ...
        $sql = "SELECT * FROM countyreturnings where  email='$myusername'";
         ...
         if ($avatar == null) {
           if ($gender == "Male") {
            ...
            echo '<img style="height:70px;" src="data:image;base64,'.$row["photo"].'" class="img-circle" alt="'.$current_countyreturnings.'" title="'.$current_countyreturnings.'"/>';
         }
                     }
                   } else {
  ...
  echo '<img style="height:150px;width:90%;margin-left:4%;"src="data:image;base64,'.$row["photo"].'" class="user-image" alt="'.$current_countyreturnings.'" title="'.$current_countyreturnings.'"/>';
  }
   }
  } else {
  ...
  <div class="content-wrapper" style="background-color:#ffff99;">
    <section class="content-header">
      ...
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        <li><a href="countyret.php"><i class="fa fa-dashboard btn btn-primary disabled glyphicon glyphicon-home"> Home</i> </a></li>
  ...
  <div class="box box-primary">
      ...
      <?php
        ...
        $sql = "SELECT * FROM countyreturnings where email='$myusername'";
         ...
         if ($avatar == null) {
           if ($gender == "Male") {
             print '<img src="../dist/img/avatar.png" class="profile-user-img img-responsive img-circle" alt="'.$current_countyreturnings.'" title="'.$current_countyreturnings.'">';
           }else {
             print '<img src="../dist/img/avatar3.png" class="profile-user-img img-responsive img-circle" alt="'.$current_countyreturnings.'" title="'.$current_countyreturnings.'">';
           }

         }else {
            echo '<img style="height:100px;" src="data:image;base64,'.$row["photo"].'" class="profile-user-img img-responsive img-circle" alt="'.$current_countyreturnings.'" title="'.$current_countyreturnings.'"/>';
         }
                     }
                   } else {
        ...
        ?>
              ...
              <h3 class="profile-username text-center"><?php echo"$current_countyreturnings"; ?></h3>
             ...
             <form action="update_profile_countyret.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="box-body ">
              ...
              <form action="update_user.php" method="post">
                <div class="form-group has-feedback">
                  ...
                  <input type="text" class="form-control" name="name" value="<?php echo"$current_countyreturnings"; ?>" placeholder="Enter your fullname" required>
                </div>
