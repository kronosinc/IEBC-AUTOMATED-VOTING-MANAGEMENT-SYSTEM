...
<head>
  ...
  <title>AMVS | CEO User Profile</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      <div class="user-panel"style="background-color:#1a000d;">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview alert alert-info" style="margin-left:4%;margin-right:4%;font-size:15px;">
          <a href="" style="text-decoration:none;">
            <i class="fa fa-database"></i>
              <span class="glyphicon glyphicon-refresh" style="color:yellow;"></span><strong style="color:black;"> CEO Page Refresh</strong>
          </a>
        </li>
        ...
        echo '<img style="height:150px;width:90%;margin-left:4%;"src="data:image;base64,'.$row["photo"].'" class="user-image imagecropper" alt="'.$current_user.'" title="'.$current_user.'"/>';
        }
           }
         } else {
  ...
  <div class="content-wrapper" style="background-color:#ffff99;">
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-cog" style="font-size:20px;"></p><b style="font-size:18px;"><i> CEO Profile</b></i>

      </h1>
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        <li><a href="ceo.php"><i class="fa fa-dashboard btn btn-primary disabled glyphicon glyphicon-home"> Home</i> </a></li>
        <li><a href=""><i class=" btn btn-primary active" >CEO User Profile</i> </a></li>
      </ol>
    </section>
...
<div class="box box-primary">
         ...
         $phone = $row['phone'];
             ...
             <form action="update_profile_ceo.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="box box-info">
            <div class="box-header bg-blue">
              ...
              <h3 class="box-title glyphicon glyphicon-user"></h3>CEO Information</h3>
...
confirm_password.onkeyup = validatePassword;
            ...
            <div class="box-footer clearfix  bg-gray">
              <button type="submit" class="pull-right btn btn-danger glyphicon glyphicon-send" name="updateceoinfo" id="sendEmail"> Update CEO Information
                <i class="fa fa-arrow-circle-up"></i></button>
            </div>
			</form>
          </div>
