...
<head>
  ...
  <title>AMVS | Agent User Profile</title>
...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
			  ...
			  ?>
                ...
                <p>
                  ...
                  <small><?php echo"$regid"; ?> , AGENT</small>
                </p>
              </li>
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      <div class="user-panel">
        ...
        <a href="#"><i class="fa fa-circle text-success"></i><h style="color:cyan;"> Logged In (Agent)</h></a>
        </div>
      </div>
        ...
        <li class="treeview alert alert-info" style="margin-left:4%;margin-right:4%;font-size:15px;">
          <a href="" style="text-decoration:none;">
            <i class="fa fa-database"></i>
              <span class="glyphicon glyphicon-refresh" style="color:yellow;"></span><strong style="color:black;"> Agent Page Refresh</strong>
          </a>
        </li>
  ...
  <div class="content-wrapper" style="background-color:#ffff99;">
    <section class="content-header">
      <h1>
        <p class="glyphicon glyphicon-cog" style="font-size:20px;"></p><b style="font-size:18px;"><i> Agent Profile</b></i>

      </h1>
      <ol class="breadcrumb pull-right bg-green"style="margin-top:-0.8%;">
        <li><a href="clerk.php"><i class="fa fa-dashboard btn btn-primary disabled glyphicon glyphicon-home"> Home</i> </a></li>
        <li><a href=""><i class=" btn btn-primary active" >Agent User Profile</i> </a></li>
      </ol>
    </section>
  ...
  <div class="box box-primary">
      ...
      <?php
        ...
        ?>
             ...
             <form action="update_profile_clerk.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="box box-info">
        <div class="box-header bg-blue">
          <i class="fa fa-user"></i>
              ...
              <h3 class="box-title glyphicon glyphicon-user"></h3>Agent Information</h3>
