          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer" style="background-color: gray;">
                <div class="pull-left">
                  <a id="ceo_profile" class="btn btn-primary btn-flat ">Profile</a>
                </div>
...
<button class="sidebar-menu btn btn-block btn active header glyphicon glyphicon-user" style="color: black;padding: 10px;background-color:#1f3f24;"><b style="color: white;"> MANAGE USERS  <span class="caret"></span></b></button>
</a>
</h4>
...
<ul class="sidebar-menu" style="background-color:white;">
         <li class="treeview alert alert" style="margin-left:1%;margin-right:1%;">
          <a href="#" style="text-decoration:none;">
            ...
            <button type="button" class="btn btn-default btn-xs" style="width:170px;font-size: 12px;"><b> County Returnings(CRO)</b></button>
         ...
         <ul class="treeview-menu" style="background-color:black;">
          ...
          <a href="#" style="text-decoration:none;">
              <i class="fa fa-user glyphicon glyphicon-play" style="text-decoration:none; color:#e68a00;font-size:16px;"></i>
            <button type="button" class="btn btn-default btn-xs" style="width:170px;font-size: 12px;"><b> Returning Officer</b></button>
             <span class="caret"></span>  
          </a>
         <ul class="treeview-menu" style="background-color:black;">
            <li>
...
<div id="loadchairsessionvoting" class="well pull-left loadchairsessionvoting" style="width: 30%;min-width: 230px;margin-top: -4%;"> 
  ...
  <div class="content-wrapper well" style="background-color:white;">
    ...
    <!--  end of breadcrumbs-->
    <section class=" content well" style="margin-top: -1.7%;">
    
    <div class="row well" id="usersinfo" style="padding: 5px;padding-bottom: -5px;">
  
      </div>
      <div class="row well" id="viewusers" style="margin:0.5%;padding: 5px; margin-top: -1.7%;">
...
<div class="modal-body" id="viewmsg" style="">
